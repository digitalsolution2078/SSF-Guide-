  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <section className="mt-8 rounded-xl border border-primary-100 bg-white p-5">
        <p className="font-semibold text-primary-900">कहाँ/कसरी बुझाउने</p>
      ...
      {checklist.commonErrors.length > 0 && (
        <section className="mt-6 rounded-xl border-l-4 border-action-500 bg-action-50 p-5">
          <p className="font-semibold text-gray-900">⚠️ सामान्य गल्ती</p>
      ...
      <p className="mt-6 text-sm text-gray-500">💡 {CHECKLIST_CONFIRM_NOTE}</p>
